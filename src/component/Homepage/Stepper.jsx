...
const Stepper = () => {
  return (
    <div className='bg-gray-300 py-[3rem]'>
      ...
      <h2 class="sm:text-4xl text-2xl font-extrabold text-center mb-16">How it works</h2>
      <div class="flex gap-12">
        <div class="p-4 text-center flex flex-col justify-center items-center gap-5  rounded bg-white shadow-lg w-[30rem]">
