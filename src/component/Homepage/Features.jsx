...
export function Feature() {
  return (
    <Container>
      <div class="bg-gray-50 px-4 py-12 font-[sans-serif] text-[#333]">
      <div class="max-w-6xl mx-auto">
        ...
        <div class="grid lg:grid-cols-3 md:grid-cols-2 max-md:max-w-lg mx-auto gap-12">
          <div class="p-4 flex bg-white rounded-md shadow-md">
            <svg xmlns="http://www.w3.org/2000/svg" fill="currentColor" class="w-12 h-12 mr-6 bg-gray-100 p-3 rounded-md shrink-0" viewBox="0 0 32 32">
            ...
            <div>
              <h3 class="text-xl font-semibold mb-2">Business Loan</h3>
              
            </div>
          </div>
          <div class="p-4 flex bg-white rounded-md shadow-md">
            <svg xmlns="http://www.w3.org/2000/svg" fill="currentColor" class="w-12 h-12 mr-6 bg-gray-100 p-3 rounded-md shrink-0" viewBox="0 0 682.667 682.667">
              <defs>
            ...
            <div>
              <h3 class="text-xl font-semibold mb-2">Personal Loan</h3>
             
            </div>
          </div>
          <div class="p-4 flex bg-white rounded-md shadow-md">
            <svg xmlns="http://www.w3.org/2000/svg" fill="currentColor" class="w-12 h-12 mr-6 bg-gray-100 p-3 rounded-md shrink-0" viewBox="0 0 512.001 512.001">
          ...
          <div class="p-4 flex bg-white rounded-md shadow-md">
            <svg xmlns="http://www.w3.org/2000/svg" fill="currentColor" class="w-12 h-12 mr-6 bg-gray-100 p-3 rounded-md shrink-0" viewBox="0 0 24 24">
            ...
            <div>
              <h3 class="text-xl font-semibold mb-2">Loan Against Property</h3>
             
            </div>
          </div>
          <div class="p-4 flex bg-white rounded-md shadow-md">
            <svg xmlns="http://www.w3.org/2000/svg" fill="currentColor" class="w-12 h-12 mr-6 bg-gray-100 p-3 rounded-md shrink-0" viewBox="0 0 504.69 504.69">
            ...
            <div>
              <h3 class="text-xl font-semibold mb-2">Gold Loan</h3>
          ...
          <div class="p-4 flex bg-white rounded-md shadow-md">
            ...
            <div>
              <h3 class="text-xl font-semibold mb-2">Education Loan</h3>
          ...
          <div class="p-4 flex bg-white rounded-md shadow-md">
            ...
            <div>
              <h3 class="text-xl font-semibold mb-2">Mobile App Micro Loan</h3>
          ...
          <div class="p-4 flex bg-white rounded-md shadow-md">
            ...
            <div>
              <h3 class="text-xl font-semibold mb-2">Mobile Finance Loan</h3>
          ...
          <div class="p-4 flex bg-white rounded-md shadow-md">
            ...
            <div>
              <h3 class="text-xl font-semibold mb-2">Daily Collection Loan</h3>
          ...
          <div class="p-4 flex bg-white rounded-md shadow-md">
            ...
            <div>
              <h3 class="text-xl font-semibold mb-2">Micro Finance Group Loan</h3>
