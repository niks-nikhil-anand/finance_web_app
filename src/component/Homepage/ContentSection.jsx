    ...
    <div className="grid grid-cols-1 gap-y-8 lg:grid-cols-2 lg:items-center lg:gap-x-16">
      ...
      <div className="grid grid-cols-2 gap-4 sm:grid-cols-3">
        ...
        >
          ...
          <h2 className="mt-2 font-bold">Finance Loan Service </h2>
        ...
        >
          ...
          <h2 className="mt-2 font-bold">Fintech Banking Service</h2>
        ...
        >
          ...
          <h2 className="mt-2 font-bold">GST Payment Service</h2>
        ...
        >
          ...
          <h2 className="mt-2 font-bold">ITR Tax Pay Service</h2>
        ...
        >
          ...
          <h2 className="mt-2 font-bold">All Services</h2>
