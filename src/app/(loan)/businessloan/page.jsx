    ...
    <div className='flex flex-col gradient_gray'>
      <div className='flex flex-col md:flex-row justify-center'>
        ...
        <div className='w-full md:w-[40rem] flex flex-col md:pt-[4rem] p-[2rem]'>
          <div>
            <h1 className='base-bold my-[2rem]'>Elevate Your Business  <span className='text-gradient-blue'>  with Legal257 Business Loans</span></h1>
            <p>Welcome to Legal257, your trusted financial partner in achieving your business aspirations. At Legal257, we understand the challenges and opportunities that come with running a business. That&apos;s why we offer comprehensive and streamlined business loan solutions designed to fuel your entrepreneurial journey. Whether you&apos;re planning to expand operations, invest in new equipment, or manage working capital, our platform provides competitive options tailored to your specific needs.</p>
          </div>
          
          <div>
            <h1 className='base-bold my-[2rem] '>Transparent and Efficient Financial Solutions <span className='text-gradient-blue'> with Legal257</span> </h1>
            <p>As the proud owner of Legal257, you deserve financial solutions that are transparent, efficient, and aligned with your business goals. Legal257 prioritizes transparency, ensuring that you have a clear understanding of terms and conditions. Our application process is efficient, requiring minimal documentation, so you can focus on what matters most—growing your business. With flexible repayment terms, attractive interest rates, and a team of experts ready to assist you at every step, Legal257 is committed to empowering your business&apos;s success and prosperity. Trust us to be your reliable financial partner, supporting you in realizing the full potential of Legal257.</p>
          </div>
        </div>
      </div>
